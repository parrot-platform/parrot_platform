defmodule Parrot.Media.TimestampGenerator do
  ...
  defp add_timestamp_and_update_state(%Buffer{payload: payload} = buffer, 
                                       %{stream_format: stream_format, 
                                         samples_processed: samples_processed} = state) do
  ...
  defp update_samples_processed(%Buffer{payload: payload}, 
                                %{stream_format: stream_format, 
                                  samples_processed: samples_processed} = state) do
    samples = calculate_samples(payload, stream_format)
